...
This repository collects a series of **practical engineering exercises** focused on  
**functional dimensioning and tolerancing of machine elements**.

The objective is to showcase my ability to:
- interpret **functional requirements**,
- apply **functional dimensioning principles**,
- define and analyze **tolerance chains**,
...
│   ├── Drawings/
│   │   ├── PDF/                  # Exported technical drawings
│   │   └── SLDDRW/               # Native SolidWorks drawing files
│   └── Parts/
...
Each exercise follows a consistent and repeatable workflow:

1. 🔍 **Functional analysis** of the mechanism  
2. 📐 **Identification of functional datums**  
3. 🎯 **Definition of critical dimensions**  
4. 🔗 **Construction of tolerance chains**  
5. ✅ **Tolerance allocation driven by functional intent**

Design choices and assumptions are explicitly stated whenever required.

---

## 📂 CAD & File Management Philosophy
